<template>
    <div class="h-12 w-12 flex items-center justify-center rounded-lg p-2 hover:bg-gray-100 dark:hover:bg-gray-900 cursor-pointer" @click="toggleDark()">

        <!-- Icona della luna (modalità dark) -->
        <svg class="fill-gray-400 block dark:hidden" fill="currentColor" viewBox="0 0 20 20">
