<template>
  <div class="flex items-center justify-center w-full py-4">
    ...
    <div class="fixed z-50 w-full h-20 max-w-3xl -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
        <div class="grid h-full w-full max-w-3xl grid-cols-5 mx-auto">
            ...
            <div id="tooltip-profile34" role="tooltip" class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
